...
public final class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(ChickGame game) {
        ...
        victoryTable.add(new Label("Victory!", skin, "victory"));
        victoryTable.row();
        victoryTable.add(new Label("Press ESC to restart.", skin, "victory"));
        victoryTable.setFillParent(true);
        victoryTable.setVisible(false);
        uiStage.addActor(victoryTable);

        engine = new Engine(new EngineConfig()
                .addSystem(new AssetSystem(skin))
                ...
                .addSystem(new SpatialSystem(8, 8))
    ...
    public void show() {
        ...
        Music music = engine.getSystem(AssetSystem.class).themeMusic;
    ...
    @Override
    public void hide() {
        engine.getSystem(AssetSystem.class).themeMusic.stop();
    }
